...
router.get(
  ...
  pgController.getMyPgsController,
);
router.get(
  "/:pgId/manage",
  authMiddleware,
  authorizeRoleMiddleware("owner"),
  pgController.getPgForOwnerController,
);
...
router.post(
  ...
  authorizeRoleMiddleware("owner"),
  validateCreatePG,
  pgController.createPgController,
);
router.put(
  "/:pgId",
  authMiddleware,
  authorizeRoleMiddleware("owner"),
  validateUpdatePG,
  pgController.updatePgController,
);
router.delete(
  "/:pgId",
  authMiddleware,
  authorizeRoleMiddleware("owner"),
  pgController.deletePgController,
);
